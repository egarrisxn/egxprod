    ...
    <>
      <header className='fixed top-0 z-50 w-full border-b bg-background/80 backdrop-blur-lg'>
        <nav className='mx-auto flex w-full max-w-screen-3xl justify-center px-2 py-4 xs:justify-between sm:px-4 lg:px-8'>
          {/* <Link href='/protected' className='hidden items-center pl-1 xs:flex'> */}
...
//   // Fetch user's avatar filename from Supabase DB
...
//   const SUPABASE_URL =
//     process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://ilguvbltlgafvgxgpdbl.supabase.co'

//   const bucketName = 'avatars'
//   const avatarFilename = userProfile?.avatar_url

//   const avatarUrl = avatarFilename
//     ? `${SUPABASE_URL}/storage/v1/object/public/${bucketName}/${avatarFilename}`
//     : '/default-avatar.png'
