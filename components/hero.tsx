    ...
    <section className='relative isolate pt-14 dark:bg-gray-900 xl:pt-24'>
      ...
      <div className='mx-auto max-w-7xl px-6 py-24 sm:py-40 lg:px-8'>
        <div className='mx-auto max-w-2xl text-center'>
          <h1 className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text py-1 text-4xl font-bold tracking-tight text-transparent sm:text-6xl'>
